...
const TOOL_NAME_MAP: Record<string, string> = {
  ...
  edit_file: '编辑文件', edit_document: '编辑文档', ocr_scan: 'OCR 识别',
  compare_knowledge: '文档比对问答', kb_upsert: '知识写回',
  ...
  batch_process: '批量处理', summarize_document: '文档总结', draft_document: '起草文档',
}
