...
<style scoped>
/* ============================================
   提示词模板管理 - Refined Technical Design
...
.edit-tabs-large :deep(.el-tabs__item) {
  font-weight: 600;
  font-size: 13.5px;
  transition: all 0.25s;
}

.edit-tabs-large :deep(.el-tabs__item.is-active) {
  color: #0d9488;
}
...
.markdown-toolbar :deep(.el-button:hover) {
  border-color: #14b8a6;
  color: #0d9488;
