...
const TYPO_MAP: Record<string, string> = {
  ...
  // 2026-08 噪音清理：移除「对与/由与/至与/终与/等与」整族误配——中文以"与"作连词极常见
  // （如「分辨对与错」「等与合同相关方」），此类条目实测全部命中合法语境误报。
  // 「除次之外」「观于」为真实错误映射，保留。
  '另为': '另外',
  '除次之外': '除此之外',
  '观于': '关于',
  ...
  '澈底': '彻底',
  '清沏': '清澈',
  // 注：'可建'→'可见' 为误配（「可建面积」为工程合法用语），2026-08 噪音清理移除
  '体显': '体现',
  '成现': '呈现',
  '表显': '表现',
  '再显': '再现',
  ...
  '宣靠': '宣告',
  '靠知': '告知',
  // 注：'通志'→'通知' 为误配（《通志》为典籍名等合法用法），2026-08 噪音清理移除
  '通抱': '通报',
  '抱告': '报告',
  '会报': '汇报',
  '回付': '回复',
